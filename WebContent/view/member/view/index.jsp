...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
      <c:url value="/view/member/static" var="url"></c:url>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<div class="wrapper">
    ...
    <div class="header-v5 header-static">
        <!-- Topbar v3 -->
<jsp:include page="/view/member/view/topbar.jsp"></jsp:include>
        <!-- End Topbar v3 -->

        <!-- Navbar -->
        <jsp:include page="/view/member/view/navbar.jsp"></jsp:include>
        <!-- End Navbar -->
    </div>
    <!--=== End Header v5 ===-->
    ...
    <div class="container content">
        ...
        <ul class="list-inline owl-slider-v2">
            <li class="item first-child">
                <img src="${url}/img/members/07.png" alt="">
            </li>
            <li class="item">
                <img src="${url}/img/members/08.png" alt="">
            </li>
            <li class="item">
                <img src="${url}/img/members/10.png" alt="">
            </li>
            <li class="item">
                <img src="${url}/img/members/11.png" alt="">
            </li>
            <li class="item">
                <img src="${url}/img/members/09.png" alt="">
            </li>
            <li class="item">
                <img src="${url}/img/members/12.png" alt="">
            </li>
            <li class="item">
                <img src="${url}/img/members/07.png" alt="">
            </li>
    ...
    <!--=== Footer v4 ===-->
   <jsp:include page="/view/member/view/footer.jsp"></jsp:include>
    <!--=== End Footer v4 ===-->
</div><!--/wrapper-->
