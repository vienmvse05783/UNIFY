...
public class ProductDaoImpl extends JDBCConnection implements ProductDao {
	...
	public void insert(Product product) {
		String sql = "INSERT INTO Product(name, price, image, cate_id) VALUES (?,?,?,?)";
	...
	public void edit(Product product) {
		String sql = "UPDATE Product SET name = ? , price = ?, image = ?,cate_id = ? WHERE id = ?";
		Connection con = super.getJDBCConnection();
	...
	public Product get(int id) {
		String sql = "SELECT product.id, product.name AS p_name, product.price, product.image, category.cate_name AS c_name, category.cate_id AS c_id "
